...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Ahmed Jamal
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">I am a passionate and dedicated creative designer based on Earth, committed to beautifying the world through my work.</p>
